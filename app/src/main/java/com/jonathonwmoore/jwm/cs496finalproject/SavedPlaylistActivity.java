...
public class SavedPlaylistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        screenLayout = (LinearLayout)findViewById(R.id.select_screen_layout_id);
        screenInstr = (TextView)findViewById(R.id.select_screen_instr);
    ...
    public void parsePlaylistData(JSONObject jobj) {
        ...
        int buttonID = 0;
        if (!keys.hasNext()) {
            screenInstr.setText("You don't have any saved stations.  Create one to get started!");
        }
        while (keys.hasNext()) {
